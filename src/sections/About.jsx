...
const About = () => {
  return (
    ...
    >
      ...
      >
        {/* Ambient orange glow */}
        <div className="absolute -left-40 top-1/4 h-80 w-80 rounded-full bg-orange-500/[0.035] blur-[110px]" />

        {/* Subtle right glow */}
        <div className="absolute -right-40 bottom-1/4 h-80 w-80 rounded-full bg-orange-500/[0.025] blur-[110px]" />

        {/* Subtle grid */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.035)_1px,transparent_1px)] [background-size:32px_32px] opacity-20" />
      </div>
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <article className="group relative overflow-hidden rounded-3xl border border-white/[0.07] bg-white/[0.02] p-7 transition-all duration-500 hover:border-orange-500/20 hover:bg-white/[0.03] sm:p-9 lg:p-10">

            {/* Top accent */}
            <div
              aria-hidden="true"
              className="absolute left-0 top-0 h-px w-24 bg-gradient-to-r from-orange-500 to-transparent opacity-70 transition-all duration-500 group-hover:w-40"
            />
          ...
          <article className="group relative overflow-hidden rounded-3xl border border-white/[0.07] bg-white/[0.02] p-7 transition-all duration-500 hover:border-orange-500/20 hover:bg-white/[0.03] sm:p-9">

            <div
              aria-hidden="true"
              className="absolute right-0 top-0 h-24 w-24 rounded-full bg-orange-500/[0.04] blur-2xl transition-all duration-500 group-hover:bg-orange-500/[0.08]"
            />
            ...
            <div className="relative">
              ...
              <div className="mt-7 space-y-7">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="mt-1 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-white/[0.07] bg-white/[0.025] text-xs text-orange-500">
                    01
                  </div>
        ...
        <div className="mt-6 grid gap-6 sm:grid-cols-3">
          ...
          {/* Card 1 */}
          <div className="group rounded-2xl border border-white/[0.07] bg-white/[0.02] p-6 transition-all duration-300 hover:-translate-y-1 hover:border-orange-500/20">
        ...
        <div className="mt-16 border-t border-white/[0.06] pt-8">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <a
              href="#builds"
              className="group inline-flex shrink-0 items-center gap-2 text-sm font-medium text-zinc-300 transition-colors duration-300 hover:text-orange-500"
            >
              Explore my work
